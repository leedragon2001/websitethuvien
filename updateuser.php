                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            ?>
                            <form method="POST" action="UpdateFunction.php" class="register-form" id="register-form">
                                <input type="hidden" class="form-control" id="tenphim" name="id"
                                    value="<?php echo $arUser['id'] ?>" tabindex="1">
                                <div class="col">
                                    <div class="row">
                                        <div class="col-6">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control" id="dienvien" name="tendocgia"
                                                value="<?php echo $arUser['tendocgia'] ?>" tabindex="2">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <label for="category-film" class="col-form-label">Major: </label>
                                            <input type="text" class="form-control" id="dienvien" name="nganhdocgia"
                                                value="<?php echo $arUser['nganhdocgia'] ?>" tabindex="2">
                                        </div>
                                        <div class="col-6">
                                            <label for="category-film" class="col-form-label">Phone Number: </label>
                                            <input type="number" class="form-control" id="daodien" name="sodienthoai"
                                                value="<?php echo $arUser['sodienthoai'] ?>" tabindex="3">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6 ">
                                            <label for="category-film" class="col-form-label">Username: </label>
                                            <input type="text" class="form-control" id="daodien" name="username"
                                                value="<?php echo $arUser['username'] ?>" tabindex="3">
                                        </div>
                                ...
                                <br>
                                <button type="submit" class="btn btn-secondary" name="edituser">Save</button>
                            </form>
                        </div>
                    </div>
                </div>
