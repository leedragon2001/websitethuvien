                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT a.*,b.ten,b.masach,b.nganh,b.nhaxb,b.tacgia FROM phieumuon as a,book as b WHERE a.book_id = b.id AND a.status != 3 AND a.madocgia = '{$madg}' AND a.tendocgia = '{$tendg}' AND a.nganhdocgia = '{$nganhdg}'  ORDER BY a.id DESC";
